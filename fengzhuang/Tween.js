...
+function(){
	...
	window.animator = {
		...
		quartEaseIn : function(ele, options, duration ,callback){ 
			this.animate(ele, options, duration, Tween.Quart.easeIn, callback);
		},
		quartEaseOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Quart.easeOut, callback);
		},
		quartEaseInOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Quart.easeInOut, callback);
		},
		quintEaseIn : function(ele, options, duration ,callback){ 
			this.animate(ele, options, duration, Tween.Quint.easeIn, callback);
		},
		quintEaseOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Quint.easeOut, callback);
		},
		quintEaseInOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Quint.easeInOut, callback);
		},
		sineEaseIn : function(ele, options, duration ,callback){ 
			this.animate(ele, options, duration, Tween.Sine.easeIn, callback);
		},
		sineEaseOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Sine.easeOut, callback);
		},
		sineEaseInOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Sine.easeInOut, callback);
		},
		expoEaseIn : function(ele, options, duration ,callback){ 
			this.animate(ele, options, duration, Tween.Expo.easeIn, callback);
		},
		expoEaseOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Expo.easeOut, callback);
		},
		expoEaseInOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Expo.easeInOut, callback);
		},
		circEaseIn : function(ele, options, duration ,callback){ 
			this.animate(ele, options, duration, Tween.Circ.easeIn, callback);
		},
		circEaseOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Circ.easeOut, callback);
		},
		circEaseInOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Circ.easeInOut, callback);
		},
		elasticEaseIn : function(ele, options, duration ,callback){ 
			this.animate(ele, options, duration, Tween.Elastic.easeIn, callback);
		},
		...
		elasticEaseInOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Elastic.easeInOut, callback);
		},
		backEaseIn : function(ele, options, duration ,callback){ 
			this.animate(ele, options, duration, Tween.Back.easeIn, callback);
		},
		backEaseOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Back.easeOut, callback);
		},
		backEaseInOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Back.easeInOut, callback);
		},
		bounceEaseIn : function(ele, options, duration ,callback){ 
			this.animate(ele, options, duration, Tween.Bounce.easeIn, callback);
		},
		...
		bounceEaseInOut : function(ele, options, duration ,callback){
			this.animate(ele, options, duration, Tween.Bounce.easeInOut, callback);
		},
